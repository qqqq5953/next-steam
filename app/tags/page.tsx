    ...
    <div className='space-y-4'>
      ...
      <section className='grid grid-cols-1 gap-4 sm:gap-6 sm:grid-cols-2 md:grid-cols-3 3xl:grid-cols-4'>
        {tags.results.map((tag: AllTags) => {
          return <Card key={tag.id} className={`overflow-hidden  border-transparent bg-neutral-800/90 relative h-[280px]`}>
            <div className="relative h-2/3">
              <ImageContainer
                url={tag.image_background} name={tag.name}
